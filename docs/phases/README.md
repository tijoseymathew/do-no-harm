...
| [05 — Grounded live conversation and examiner checkpoints](05-live-conversation-and-examiner.md) | Live conversation and the persistent examiner session use actual run evidence while respecting treatment and information boundaries. | Phases 01, 03, and 04. | Blocked (implementation and real examiner continuity pass; browser voice gate and dependencies pending) |
